# Run agent-regime only (baseline + sweep + fill analysis §2/§3).
# Use if risk-exit finished but regime was not started.
...
function Log($msg) {
    $line = "$(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') [regime-only] $msg"
