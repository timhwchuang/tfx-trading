"""FT-023: CF plan vs kernel execution parity for gudt_wash_beta."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="FT-023 wash-beta execution parity")
    ...
    parser.add_argument("--append-spot-log", action="store_true")
    ...
    if args.append_spot_log:
        ...
        elif getattr(args, "spot_check", None):
        ...
        append_spot_check_log(
            ...
            command=" ".join(cmd_parts) or "ft023_execution_parity",
            result=result,
        )
