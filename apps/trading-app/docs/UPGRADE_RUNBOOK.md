...
> **DEPRECATED（2026-06-17）** — 已遷移至 [`tfx-trading`](https://github.com/timhwchuang/tfx-trading) monorepo。  
> **現行 SOP**：[`monorepo/SPEC.md`](../../../monorepo/SPEC.md) §7 · 安裝：[`scripts/setup-dev.sh`](../../../scripts/setup-dev.sh)
