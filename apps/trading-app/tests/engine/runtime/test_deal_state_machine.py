...
class TestDealStateMachine(unittest.TestCase):
    def test_entry_deal_updates_position(self):
        ...
        self.assertEqual(host._book.entry_price, 18000.0)
        self.assertEqual(host._book.entry_exchange_ts, 1000)
        self.assertEqual(host._book.ticks_since_entry, 0)
    ...
    def test_exit_deal_clears_position_and_updates_pnl(self):
        ...
        host._book.entry_exchange_ts = 1000
        host._book.ticks_since_entry = 80
        ...
        self.assertEqual(host._book.daily_pnl, 20.0)
        self.assertEqual(host._book.entry_exchange_ts, 0)
        self.assertEqual(host._book.ticks_since_entry, 0)
