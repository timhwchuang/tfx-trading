...
class TestNoTickEscalation(unittest.TestCase):
    def _host(self, *, escalate_after: int = 3) -> object:
        ...
        host._ticks._last_tick_exchange_dt = datetime.datetime(2026, 6, 23, 10, 0, 0)
        host._wall = 1_000.0
        host._clock = lambda: host._wall
        host._ticks._last_tick_wall_time = host._wall - 120
        host._ticks._last_no_tick_resubscribe_wall = 0.0
    ...
    def test_escalates_after_threshold_resubscribes(self) -> None:
        ...
        self.assertEqual(host._ticks._no_tick_resubscribe_streak, 0)
    ...
    def test_below_threshold_only_resubscribes(self) -> None:
        ...
        self.assertEqual(host._ticks._no_tick_resubscribe_streak, 1)
    ...
    def test_tick_resets_streak(self) -> None:
        host = self._host()
        host._ticks._no_tick_resubscribe_streak = 2
    ...
    def test_reconnect_during_resubscribe_cancels_escalation(self) -> None:
        ...
        def resubscribe_then_reconnect() -> None:
            host._ticks._no_tick_resubscribe_streak = 0
            host._link._connected_reconnect_generation += 1
    ...
    def test_tick_during_escalation_cancels_disconnect(self) -> None:
        ...
        def resubscribe_then_tick() -> None:
            host._ticks._last_tick_wall_time = host._wall
