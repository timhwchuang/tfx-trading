...
class TestPositionQty(unittest.TestCase):
    def test_entry_full_sets_qty_from_filled(self):
        ...
        self.assertEqual(host._book.position_qty, 3)
    ...
    def test_partial_entry_keeps_pending_and_does_not_set_position_yet(self):
        ...
        self.assertEqual(host._book.filled_qty, 1)
        self.assertEqual(host._book.position_qty, 0)  # not yet applied
    ...
    def test_exit_full_flattens_qty_to_zero(self):
        ...
        self.assertEqual(host._book.daily_pnl, 40.0)  # 20 pts × 2 lots
    ...
    def test_multi_lot_exit_scales_pnl_by_filled_qty(self):
        ...
        self.assertEqual(host._book.position_qty, 0)
        self.assertEqual(host._book.daily_pnl, 60.0)  # 20 pts × 3 lots
    ...
    def test_oversized_exit_fill_capped_at_position_qty(self):
        ...
        self.assertEqual(host._book.position_qty, 0)
        self.assertEqual(host._book.daily_pnl, 40.0)  # capped at 2 lots, not 5
    ...
    def test_multi_lot_partial_exit_pnl_uses_each_fill_price(self):
        ...
        self.assertEqual(host._book.position_qty, 0)
        self.assertEqual(host._book.daily_pnl, 9.0)
    ...
    def test_sync_positions_writes_qty_from_broker(self):
        ...
        self.assertEqual(host._book.position_dir, "Long")
        self.assertEqual(host._book.entry_price, 17950.0)
