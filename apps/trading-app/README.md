...
**Monorepo packages** (editable install from repo root):

- `packages/trading-engine` `@ v0.2.2`
- `packages/trading-backtest` `@ v0.1.1`
- `packages/strategies/vwap-momentum` `@ v0.1.2`

See [SPEC.md](../../SPEC.md) and [docs/Architecture.md](../../docs/Architecture.md).
...
或僅 app 目錄：`pip install -r apps/trading-app/requirements.txt`（path editable）。
