...
## Next (roadmap Setup A′ step 1)

Change stop spec in `setup_a.py`. `stop_buffer` is a pad. Smoke 8 timestamps /
~20 days, conservative, and report 13:40 flatten share vs 2R. No 432-cell grid.
