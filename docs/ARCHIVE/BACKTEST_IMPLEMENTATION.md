...
> **Archived 2026-06-17** — 現行真相見 [`packages/trading-backtest/SPEC.md`](../../packages/trading-backtest/SPEC.md)。

> **Owner**: `trading-backtest`  
> **Companion**: [packages/trading-backtest/SPEC.md](../../packages/trading-backtest/SPEC.md) (package API), [trading-engine SPEC §12](../../packages/trading-engine/SPEC.md)
