...
Designed for ~1-lot TAIFEX day-session strategies. See [packages/trading-engine/SPEC.md §4.2.1](../../../packages/trading-engine/SPEC.md) and [docs/ops/LIVE_SAFETY.md](../../ops/LIVE_SAFETY.md).
