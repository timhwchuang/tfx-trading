...
Breaking changes (e.g. removing Protocol methods) will trigger a **major** semver bump per [packages/trading-engine/SPEC.md](../../../packages/trading-engine/SPEC.md) §9.
...
- [packages/trading-engine/SPEC.md §4.2](../../../packages/trading-engine/SPEC.md) — public API summary
