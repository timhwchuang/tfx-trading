...
> **Alpha 儀式**：[`ALPHA_RESEARCH_PLAYBOOK.md`](../docs/features/ai-backtest-tuning/ALPHA_RESEARCH_PLAYBOOK.md) · **提案佇列** [`THESIS_QUEUE.md`](THESIS_QUEUE.md)（Agent 可草稿，人類 Pick 後才跑 CF）
