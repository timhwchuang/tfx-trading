...
> **Alpha 儀式**：[`ALPHA_RESEARCH_PLAYBOOK.md`](../docs/features/ai-backtest-tuning/ALPHA_RESEARCH_PLAYBOOK.md)（v1.6） · **Preflight** [`GATE_COVERAGE_PREFLIGHT.md`](../docs/features/ai-backtest-tuning/GATE_COVERAGE_PREFLIGHT.md) · **提案佇列** [`THESIS_QUEUE.md`](THESIS_QUEUE.md)（Agent 可草稿，人類 Pick 後才跑 CF）
...
| [`VOLATILITY_BASELINE.md`](VOLATILITY_BASELINE.md) | **Phase 3.6** 四平面診斷數據 SSOT（§A/B 尺度 · **§C 進場漏斗** · §D 出場 · §E.2 range_M） |
| [`GATE_COVERAGE_PREFLIGHT.md`](../docs/features/ai-backtest-tuning/GATE_COVERAGE_PREFLIGHT.md) | **Alpha 0-design** Gate 觸發率／隱含 n SSOT（FT-011+ · Preflight PASS 後才 human-approved） |
